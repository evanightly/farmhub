        ...
        <>
            ...
            <div className="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
                ...
                {products.length > 0 ? (
                        ...
                        {products.map((product) => (
                            <Card.Card key={product.id} className="h-full">
                                ...
                                <Card.CardContent>
                                    ...
                                    <p className="mt-2 text-xs text-[#6e6e6c] dark:text-[#A3A3A1]">
                                        Harvest Date: {product?.harvest_date}
                                    </p>
                                    <p className="mt-1 text-xs text-[#6e6e6c] dark:text-[#A3A3A1]">
                    ...
                    <p className="text-center text-sm text-[#6e6e6c] dark:text-[#A3A3A1]">
    ...
    if (!product.product_images || product.product_images.length === 0) {
        return (
            <div className="mb-4 flex h-32 w-full items-center justify-center rounded-md bg-[#e0e0e0] dark:bg-[#1b1b18]">
                <span className="text-sm text-[#6e6e6c] dark:text-[#A3A3A1]">
                    No Image
                </span>
            </div>
        );
