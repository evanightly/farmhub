...
This guide explains how to configure and operate the GitHub Actions workflow that deploys Farmhub to InfinityFree (or similar shared hosting). The workflow file lives at `.github/workflows/deploy-infinityfree.yml`.
